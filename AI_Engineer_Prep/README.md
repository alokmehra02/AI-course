...
| **Gemini Live voice (VoXgent)** | [Interview guide](./GEMINI_LIVE_VOICE_AGENT_INTERVIEW_GUIDE.md) · [Complete reference](./GEMINI_LIVE_VOICE_AGENT_INTERVIEW_GUIDE_COMPLETE.md) · [Pipeline canvas](./gemini-live-pipeline-whiteboard.canvas.tsx) |
